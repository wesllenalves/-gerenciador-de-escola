    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col text-right"> <a class="btn btn-sm" style="background-color: green; color: white" href="disciplina_form.jsp" role="button">Novas Disciplinas</a> &nbsp;</div>
             </div>
  <h2>Disciplinas</h2>
  <p>Lista de disciplinas cadastradas no sistema</p>   
