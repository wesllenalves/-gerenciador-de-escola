    ...
    <div class="container my-4">
          ...
          <div class="container">
            <div class="row">
                ...
                <div class="col text-right"> <a class="btn btn-sm" style="background-color: green; color: white" href="curso_lista.jsp" role="button">Listar Cursos</a> &nbsp;</div>
                <br>
            </div>
     ...
     <c:if test = "${msg != null}">
        ...
        <p>&nbsp;&nbsp;&nbsp;Formulário de cadastro de novos cursos no sistema</p> 
            </div>
