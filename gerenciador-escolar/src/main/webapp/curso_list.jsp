    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col text-right"> <a class="btn btn-sm" style="background-color: green; color: white" href="curso_form.jsp" role="button">Novos Cursos</a> &nbsp;</div>
             </div>
  <h2>Cursos</h2>
  <p>Lista de cursos cadastrados no sistema</p>   
