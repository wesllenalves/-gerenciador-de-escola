    ...
    <div class="container my-4">
          ...
          <div class="container">
            <div class="row">
                ...
                <div class="col text-right"> <a class="btn btn-sm" style="background-color: green; color: white" href="disciplina_lista.jsp" role="button">Listar Diciplinas</a> &nbsp;</div>
                <br>
            </div>
     ...
     <c:if test = "${msg != null}">
        ...
        <p>&nbsp;&nbsp;&nbsp;Formulário de cadastro de novas disciplinas no sistema</p> 
            </div>
