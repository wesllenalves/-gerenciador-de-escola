 ...
 */
public class AlunoSvl extends HttpServlet {
    ...
    public static List<Aluno> obterAlunos() {
        List<Aluno> lAlunos;
        lAlunos = AlunoDAO.getInstance().obterTodosOsAlunos();
